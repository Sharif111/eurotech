    ...
    <div class="col-md-12">
      <div class="main_content_area">
        <div class="main_content_header">
          <h4><i class="fa fa-money"></i>Service List</h4>
        </div>
        <div class="content_filds">
            <div class="col-md-12">
                ...
                <a href="{{URL::to('/admin/service')}}" class="btn btn-info"><i style="color:white;" class="fa fa-layer-plus"></i>Add New Service</a>
