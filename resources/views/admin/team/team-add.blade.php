    ...
    <div class="col-md-12">
      <div class="main_content_area">
        <div class="main_content_header">
          <h4><i class="fa fa-user-o"></i> Portfolio</h4>
        </div>
        <div class="content_filds">
            ...
            <div class="col-md-12">
              ...
              <form action="{{ URL::to('admin/team') }}" method="POST" enctype="multipart/form-data">
                @csrf()
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label for="slider">Upload Team Member Image :</label>
