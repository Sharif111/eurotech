                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input id="sub_title" type="text" class="form-control"  name="sub_title" value="{{ old('email') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="description">Description :</label>
                            <textarea name="description" id="description" cols="83" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <img id="output" src="" style="height:90px;width:150px" class="img img-responsive" alt="">
                        <br>
                    </div>
                </div>
              </form>
